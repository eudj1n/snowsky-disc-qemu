...
[REMOTE_SETTINGS.md](../../docs/protocol/remote-settings.md), including the differences between wire
...
hotplug to remount the card. See [MEDIA_LIBRARY.md](media-library.md) for the exact
