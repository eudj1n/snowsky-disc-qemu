...
Status: **V2.57 emulator source release**.
Final commit and hosted validation: [release notes](https://github.com/eudj1n/snowsky-disc-qemu/releases/tag/v2.57).
V2.57 is the default. V2.40 remains available explicitly; existing volumes and its immutable tag are unchanged.
...
1. Run firmware-free checks and V2.57 hosted integration on each release candidate.
   ...
   its retained manual CI choice is optional until legacy cleanup.
