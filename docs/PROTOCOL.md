...
[REMOTE_SETTINGS.md](REMOTE_SETTINGS.md) covers gain, DRE, filter, SPDIF and PEQ.
[REMOTE_MODES_THEMES.md](REMOTE_MODES_THEMES.md) adds work-mode transitions,
...
[FIIO_CONTROL_APP.md](FIIO_CONTROL_APP.md).
The [M21 comparison](M21_COMPARISON.md) records the related Android BLinker dialect:
...
single-path deletion and custom playlist operations; see [HTTP_API.md](HTTP_API.md)
...
credentials was incorrect. See [REMOTE_CONTROL.md](REMOTE_CONTROL.md#official-app-ui-evidence).
...
[REMOTE_CONTROL.md](REMOTE_CONTROL.md). No absolute play/pause command is established;
