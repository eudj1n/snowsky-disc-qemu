...
This extends [REMOTE_SETTINGS.md](remote-settings.md) and [HTTP_API.md](http-api.md).
...
[packet evidence](../../research/docs/reports/fiio-control-app.md#ios-raw-tcp-capture-2026-09-15) and
...
[capture details](../../research/docs/reports/fiio-control-app.md#ios-codec-capture-2026-09-15) and the
...
[Capture and evidence limits](../../research/docs/reports/fiio-control-app.md#physical-system-theme-opacity-2026-09-16).
...
The [physical style capture](../../research/docs/reports/fiio-control-app.md#physical-custom-style-save-2026-09-16)
...
- A **custom POST with an empty body clears the stored image path**. The file can
  ...
  [packet evidence and alias limitation](../../research/docs/reports/fiio-control-app.md#physical-custom-theme-save-2026-09-16).
...
See [app evidence](../../research/docs/reports/fiio-control-app.md#ios-460-observed-http-2026-09-15) and the
...
[capture evidence](../../research/docs/reports/fiio-control-app.md#physical-custom-theme-save-2026-09-16)
...
See [screen coverage and gaps](../../research/docs/reports/fiio-control-app.md#wallpaper-screens-first-batch-2026-09-16).
...
[analysis](../../research/docs/reports/fiio-control-app.md#physical-system-theme-opacity-2026-09-16) closes
...
6822–6825. [Analysis](../../research/docs/reports/fiio-control-app.md#physical-system-theme-colors-2026-09-16)
