...
def ensure_issue(repo, current, latest):
    ...
    body = (
        ...
        '- [ ] Obtain the package and record verified inventory following `firmware/docs/porting.md`.\n'
        ...
        '- [ ] Apply the single-active-firmware policy in `firmware/docs/porting.md`: '
        'preserve the previous firmware\'s final validated release before promoting '
        'the validated candidate; then retire old runtime/CI compatibility code. '
        'Keep historical tags, inventories and analysis, without promised backports. '
        'OTA detection alone does not replace the working version.\n'
