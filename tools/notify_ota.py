...
def ensure_issue(repo, current, latest):
    ...
    body = (
        ...
        '- [ ] Apply the three-version FIFO support policy in `docs/PORTING.md`: '
        'after validation and release preparation, a fourth supported firmware '
        'retires the oldest from current runtime support and CI; preserve historical '
        'tags, inventories and analysis. OTA detection alone does not move the window.\n'
