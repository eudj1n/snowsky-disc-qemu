...
This is separate from the [normal browser viewer](../../../viewer/docs/usage.md). Here the browser
...
![Browser experiment with the V2.57 main menu](../../../docs/images/readme-browser.png)
...
Dimmed controls are not connected in this experiment. [Capture details](../../../docs/images/README.md).*
...
513 px square body and native 360×360 display as the [QEMU Viewer](../../../viewer/docs/usage.md),
...
![Browser experiment debug tools and console](../../../docs/images/browser-debug.png)
...
1. Downloads public dependencies pinned by SHA-256 in
   [sources.json](../sources.json). No firmware is downloaded.
