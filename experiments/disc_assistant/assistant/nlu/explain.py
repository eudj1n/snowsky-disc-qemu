...
from experiments.disc_assistant.assistant.nlu.intents import parse, language_target, Intent, ControlIntent, LanguageIntent, VolumeIntent
...
def preview(config, text, trace=None):
    ...
    try:
        ...
        import asyncio
        from experiments.disc_assistant.assistant.nlu.interpretation_sources import explain_sources
