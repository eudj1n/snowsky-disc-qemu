"""Opt-in experiments: python -m experiments.disc_assistant.assistant.nlu.evaluation --help."""
import argparse
import asyncio
import json
import math
...
from experiments.disc_assistant.assistant.nlu.evaluation.encoder import Encoder, prepare
from experiments.disc_assistant.assistant.nlu.evaluation.intents import evaluate, load_corpus
...
async def run(args):
    ...
    try:
        ...
        if args.with_retrieval:
            from experiments.disc_assistant.assistant.nlu.evaluation.retrieval import evaluate as retrieval_evaluate
