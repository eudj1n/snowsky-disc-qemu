...
from experiments.disc_assistant.assistant.nlu.command_catalog import CommandCatalog, digest
from experiments.disc_assistant.assistant.nlu.interpreter import InterpretationContext
...
from experiments.disc_assistant.assistant.nlu.evaluation.dataset import load
...
def main(argv=None):
    ...
    manifest, rows = load(DATA / 'datasets/commands-v2')
    acceptance = json.loads((DATA / 'slot_acceptance.json').read_text())
