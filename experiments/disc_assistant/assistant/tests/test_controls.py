...
from experiments.disc_assistant.assistant import controls
...
from experiments.disc_assistant.assistant.device import ObservedSocket, PlaybackClient
from experiments.disc_assistant.assistant.nlu.intents import ControlIntent, Intent, parse as parse_text
from experiments.disc_assistant.assistant.tests.test_playback import FakeClient
...
class ControlsTests(unittest.TestCase):
    ...
    def test_cli_controls_and_dry_run_need_no_search_or_catalog_database(self):
        ...
        with patch('experiments.disc_assistant.assistant.__main__.Store') as store, \
                patch('experiments.disc_assistant.assistant.__main__.create_client') as search, \
                patch('experiments.disc_assistant.assistant.__main__.control', return_value={'status': 'confirmed'}) as control, \
