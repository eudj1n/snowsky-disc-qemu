...
from experiments.disc_assistant.assistant.nlu.command_catalog import CommandCatalog, LABELS, digest, source, command
from experiments.disc_assistant.assistant.nlu.command_features import VERSION, classify, counts
...
from experiments.disc_assistant.assistant.nlu.evaluation.train_commands import validate_splits
...
class CommandTests(unittest.TestCase):
    ...
    def test_changed_examples_and_rules_require_explicit_rebuild(self):
        ...
        for key in ('examples','rules'):
            ...
            with patch('experiments.disc_assistant.assistant.nlu.command_catalog.source',return_value=authored):
