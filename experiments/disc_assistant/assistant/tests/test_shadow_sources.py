...
from experiments.disc_assistant.assistant.nlu.command_catalog import CommandCatalog
...
from experiments.disc_assistant.assistant.nlu.interpreter import Interpretation, InterpretationContext, interpret_request, UnsupportedCommand
from experiments.disc_assistant.assistant.nlu.interpretation_sources import (
    Evidence, LiteralSource, SlotSource, CommandModelSource, collect, diagnostic_choice, comparison)
from experiments.disc_assistant.assistant.nlu.intents import ControlIntent
...
from experiments.disc_assistant.assistant.tests.test_commands import bundle
...
class SourceFlowTests(unittest.TestCase):
    ...
    def test_cli_and_console_journal_shadow_success_rejection_and_voice_path(self):
        ...
        with patch('experiments.disc_assistant.assistant.application.transcribe_file',AsyncMock(return_value=transcript)):
    ...
    def test_disabled_shadow_does_not_evaluate_sources(self):
        ...
        with patch('experiments.disc_assistant.assistant.nlu.interpretation_sources.collect',AsyncMock(side_effect=AssertionError('shadow disabled'))):
