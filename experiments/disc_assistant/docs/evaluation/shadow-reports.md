...
[shadow observations](../architecture/interpretation-sources.md) to the existing
[annotation workflow](nlu-data.md). It reads only the supplied history
...
[MVP end-to-end baseline](../reference/mvp.md), followed by agreed thresholds.
