...
It is not a blocker for the [accepted software MVP](../reports/2026-09-19-mvp-acceptance.md).
...
and the [baseline-first acceptance policy](../reference/mvp.md).
...
The owner proposed [emulator scenario automation](emulator-acceptance.md)
...
[`evaluation/acceptance/observations.template.csv`](../../evaluation/acceptance/observations.template.csv).
