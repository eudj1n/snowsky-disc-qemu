...
[`commands-v2`](../../assistant/nlu/data/datasets/commands-v2/README.md)
...
The [full report](../../assistant/nlu/evaluation/reports/2026-09-18-commands-v2.json)
...
[NLU setup](../../assistant/nlu/evaluation/README.md#reproduce), then:

```sh
lab=/tmp/disc-nlu-lab
"$lab/venv/bin/python" -m experiments.disc_assistant.assistant.nlu.evaluation.dataset validate \
...
"$assistant_python" -m experiments.disc_assistant.assistant.nlu.evaluation.dataset collect \
...
```sh
"$assistant_python" -m experiments.disc_assistant.assistant.nlu.evaluation.dataset freeze \
...
[Argument/context extraction and independent shadow sources](../architecture/interpretation-sources.md)
...
The [shadow-report workflow](shadow-reports.md) now selects observed
...
end-to-end acceptance is tracked separately in [the MVP plan](../reference/mvp.md).
