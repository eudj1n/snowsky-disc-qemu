...
| `sources`, `policy`, `context` | Independent evidence, single-action policy and interpretation context; see [source contract](../architecture/interpretation-sources.md) |
...
The current diagnostic candidate uses [independent sources](../architecture/interpretation-sources.md):
...
Community files [`assistant/locales/commands/`](../../assistant/locales/commands)
...
The isolated [supervised experiment](../../assistant/nlu/evaluation/README.md#supervised-command-study)
...
The later [v2 data workflow](../evaluation/nlu-data.md) adds 609 annotated rows,
...
miss new language/music slots. A subsequent [argument/source increment](../architecture/interpretation-sources.md)
