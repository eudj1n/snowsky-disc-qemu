...
see [architecture and migration](../architecture/pipeline.md).
...
The [speech provider contracts](../architecture/pipeline.md#speech-provider-contracts)
...
See [adding locales](locales.md), the
[command reference](../guides/commands.md) and [journal](../guides/history.md).
