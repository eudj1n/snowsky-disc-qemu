...
[emulator-based software boundary](../reference/mvp.md). The owner explicitly deferred
...
The [curated machine-readable report](../../evaluation/acceptance/reports/2026-09-19-emulator-mvp.json)
...
[runner instructions](../evaluation/emulator-acceptance.md) for prerequisites and case
