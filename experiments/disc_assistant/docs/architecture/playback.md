...
`experiments/disc_assistant/`. See [commands](../guides/commands.md) for available
behavior and [the implementation plan](../roadmap.md) for the broader roadmap.
...
[remote control](../../../../docs/protocol/remote-control.md#timing-and-state), [capabilities](../../../../docs/protocol/disc-capabilities.md).
...
See [EOF evidence](../../../../docs/protocol/track-end.md).
...
selection is retried. See [the confirmation contract](../../../../controller/docs/api.md#use).
...
[artist-scoped playback](../../../../docs/protocol/library-browsing.md#browse-and-play).
...
gapless audible transitions. See [EOF](../../../../docs/protocol/track-end.md).
...
using it; a matching name alone does not establish ownership. See [PLAYLISTS.md](../../../../docs/protocol/playlists.md).
...
pre-wait snapshot. See [Controller timing contract](../../../../controller/docs/api.md#protocol-and-concurrency-guarantees).

Device-operation results include an operation ID. The [request journal](../guides/history.md)
...
leaves controls available. See the [console commands](../guides/commands.md#interactive-console).
...
The [shared Controller API](../../../../controller/docs/api.md) now owns this session/state core
and verified device operations. Assistant retains its policy and request journal.
Quantified physical playback/session validation remains separate. Browser microphone
input is implemented through the [web adapter](../guides/web.md).
...
See [emulator regression results](../evaluation/emulator-acceptance.md).
