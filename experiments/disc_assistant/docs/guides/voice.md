...
Current browser entry point: [Disc Assistant Web](web.md) records a bounded
...
The [2026-09-18 report](../../assistant/voice/evaluations/2026-09-18.json)
...
The owner-requested [base/small comparison rerun](../../assistant/voice/evaluations/2026-09-18-base-small-comparison.json)
...
For the current web runtime, use [common speech setup](tts.md):
...
[`assistant/voice/samples/`](../../assistant/voice/samples).
...
[the architecture contract](../architecture/pipeline.md#interpretation). Generation
...
reply dictionaries still follows [the locale guide](../reference/locales.md).
...
[the comparison plan and acceptance criteria](../evaluation/nlu-research.md).

### Recorded catalog comparison

The [catalog selection report](../../assistant/voice/evaluations/2026-09-18-catalog-selection.json)
...
See [measured review comparisons](../reports/2026-09-18-review-evaluation.md) and the two
