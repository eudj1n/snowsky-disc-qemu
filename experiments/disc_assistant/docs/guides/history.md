...
[command snapshots](../reference/command-catalog.md). Migration preserves preferences
...
See [timing and debug commands](commands.md#timing-and-live-debug-traces).
...
The subsequent [shared Controller API](../../../../controller/docs/api.md) extraction is now
...
The [architecture refactor](../architecture/pipeline.md) adds interpretation provider
...
The [annotation tool](../evaluation/nlu-data.md#collect-a-private-annotation-queue) can
...
With optional [shadow comparison](../architecture/interpretation-sources.md),
