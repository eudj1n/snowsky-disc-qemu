...
from controller.fiio_http import HTTPClient, Reply, name_header, range_body, sd_path
...
class HTTPTests(unittest.TestCase):
    ...
    def test_invalid_mutations_do_not_connect(self):
        ...
        with patch('controller.fiio_http.http.client.HTTPConnection') as connection:
            for call in calls:
                with self.assertRaises(ValueError):
                    call()
