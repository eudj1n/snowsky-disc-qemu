...
from controller.fiio_link import Client, Frames, frame, index_payload, library_page, main, playback_snapshot
    ...
    def test_invalid_cli_cannot_change_volume_before_rejecting_navigation(self):
        for args in (['--volume', '30', '--play-index', '-1'],
            ...
            with self.subTest(args=args), patch('sys.argv', ['fiio_link'] + args), \
                 patch('sys.stderr', io.StringIO()), patch('controller.fiio_link.Client') as client:
