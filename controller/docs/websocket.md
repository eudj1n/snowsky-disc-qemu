...
has no WS route/message dispatcher; see [the route investigation](../../emulator/docs/network.md#websocket-investigation).
...
albums), see [REMOTE_CONTROL.md](../../docs/protocol/remote-control.md). TCP and `WSClient` share payload
