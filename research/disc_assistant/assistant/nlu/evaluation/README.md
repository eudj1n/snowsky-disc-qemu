...
"$lab/venv/bin/python" -m pip install -r research/disc_assistant/assistant/nlu/evaluation/requirements.txt
"$lab/venv/bin/python" -m research.disc_assistant.assistant.nlu.evaluation prepare --work "$lab"
"$lab/venv/bin/python" -m research.disc_assistant.assistant.nlu.evaluation evaluate \
