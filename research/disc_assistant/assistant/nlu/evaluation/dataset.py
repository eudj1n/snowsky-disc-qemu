...
from research.disc_assistant.assistant.nlu.command_catalog import LABELS, digest
from research.disc_assistant.assistant.nlu.intents import ControlIntent, Intent, LanguageIntent
