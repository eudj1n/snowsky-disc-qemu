...
from research.disc_assistant.assistant.nlu.command_catalog import CommandCatalog, digest
...
from research.disc_assistant.assistant.nlu.evaluation.dataset import load
