...
from research.disc_assistant.assistant.journal import Trace, JournalWriteError, debug_stderr, history_command
from research.disc_assistant.assistant.responses import exception_result
...
class ObservabilityTests(unittest.TestCase):
    ...
    def test_monotonic_timing_is_returned_and_persisted(self):
        clock = [100.0]
        events = []
        with patch('research.disc_assistant.assistant.journal.time.monotonic', side_effect=lambda: clock[0]):
