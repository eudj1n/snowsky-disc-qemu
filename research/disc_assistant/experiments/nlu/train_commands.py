...
from research.disc_assistant.assistant.command_catalog import LABELS, CommandCatalog, digest, source
from research.disc_assistant.assistant.command_features import VERSION, counts, vector, classify
...
from research.disc_assistant.experiments.nlu.intents import load_corpus, metrics, calibrate, accepted
...
def main():
    ...
    corpus=load_corpus(ROOT/'intents.json')
