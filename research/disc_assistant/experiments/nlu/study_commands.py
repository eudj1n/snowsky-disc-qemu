...
from research.disc_assistant.assistant.command_catalog import CommandCatalog, digest, source
...
from research.disc_assistant.experiments.nlu.dataset import audit, load
from research.disc_assistant.experiments.nlu.encoder import Encoder
from research.disc_assistant.experiments.nlu.intents import accepted, metrics
from research.disc_assistant.experiments.nlu.train_commands import fit_features, matrix, export_model, evidence, scored
...
def main():
    ...
    parser.add_argument('--dataset', type=Path, default=ROOT / 'datasets/commands-v2')
        ...
        report = {'version': 2, 'dataset': manifest, 'audit': summary, 'model': encoder.info,
                  ...
                  'code_sha256': {name: hashlib.sha256((ROOT / name).read_bytes()).hexdigest()
                                  for name in ('dataset.py', 'study_commands.py', 'train_commands.py', 'encoder.py', 'intents.py',
                                               '../../assistant/command_features.py', '../../assistant/explain.py',
                                               '../../assistant/intents.py', '../../assistant/languages.py')}, 'locales': {}}
