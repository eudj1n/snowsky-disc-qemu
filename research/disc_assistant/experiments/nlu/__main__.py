"""Opt-in experiments: python -m research.disc_assistant.experiments.nlu --help."""
import argparse
import asyncio
import json
import math
...
from research.disc_assistant.experiments.nlu.encoder import Encoder, prepare
from research.disc_assistant.experiments.nlu.intents import evaluate, load_corpus
...
async def run(args):
    ...
    music=json.loads((PACKAGE/'music.json').read_text())
    ...
    try:
        ...
        if args.with_retrieval:
            from research.disc_assistant.experiments.nlu.retrieval import evaluate as retrieval_evaluate
