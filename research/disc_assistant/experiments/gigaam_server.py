...
from research.disc_assistant.assistant.speech import InvalidSpeech
from research.disc_assistant.assistant.voice.files import wav_audio, audio_details
...
def main():
    ...
    if installed.get('vcs_info', {}).get('commit_id') != UPSTREAM_REVISION:
        parser.error('install the pinned experiments/requirements-gigaam.txt')
