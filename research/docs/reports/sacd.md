...
The existing snapshot/position identity rules in [FORMATS.md](../../../docs/protocol/formats.md) still
...
Results and failures are recorded in [PROTOCOL_RESEARCH.md](../status.md).
