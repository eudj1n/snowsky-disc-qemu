...
- [x] Sanitized FiiO Control iOS capture fixtures, app-version evidence, and
  [Android comparison](m21-comparison.md): [app evidence](fiio-control-app.md).
...
by these phone previews. [Evidence](fiio-control-app.md#physical-system-theme-colors-2026-09-16).
...
reboot persistence claim. [Evidence and regression fixture](fiio-control-app.md#physical-system-theme-opacity-2026-09-16).
...
[capture evidence](fiio-control-app.md#physical-custom-theme-save-2026-09-16).
...
- [x] **Custom-theme color/Date save in FiiO Control:** physical HAR/PCAP confirms
  ...
  Clock selection has 200 but no final GET. See [evidence](fiio-control-app.md#physical-custom-theme-save-2026-09-16).
- [x] **Four custom styles:** physical POST/GET captures confirm `default/0`,
  ...
  independent time off/on. [Evidence and limits](fiio-control-app.md#physical-custom-style-save-2026-09-16).
...
- [x] **Screen/capability audit:** supplied screenshots and subsequent captures
  are mapped to helpers, evidence and limits in [the app inventory](fiio-control-app.md)
...
is indexed in [FIIO_CONTROL_APP.md](fiio-control-app.md).
