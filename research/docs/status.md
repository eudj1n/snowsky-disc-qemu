...
PEQ/SACD and Assistant paragraphs in `docs/development/ci.md`; code merged without conflicts.
...
Share/login investigation is needed. Details and capture hashes: [PEQ](reports/peq.md).
...
not independently rechecked runtime evidence. See [SACD](reports/sacd.md#status-audit-2026-09-17).
...
`2.x`. This checkpoint is not a firmware release. See [SACD](reports/sacd.md) and
[PEQ](reports/peq.md) for contracts, scope and commands.
...
was captured. Sanitized fixture/regression and details are in [PEQ.md](reports/peq.md).
...
Fixture, screenshot hashes and detailed limits are in [PEQ.md](reports/peq.md).
...
capture is required; see [PEQ](reports/peq.md#physical-local-apply-and-v257-format-mismatch-2026-09-17).
...
Only approved Custom 10 may be overwritten. See [PEQ](reports/peq.md).
...
[capability summary](../../docs/protocol/disc-capabilities.md): supported client operations, physical
...
requirement. See [the support policy](../../firmware/docs/porting.md#support-policy--one-active-firmware).
...
- [x] Playback, metadata, seek, modes and favorites: [remote control](../../docs/protocol/remote-control.md).
- [x] Stock file transfer, HTTP catalog, custom playlist CRUD and network indexing:
  [HTTP API](../../docs/protocol/http-api.md).
- [x] V2.57 custom-playlist whole-list and indexed playback over TCP/WS,
  guarded by fresh HTTP name/track reads: [playlist contract](../../docs/protocol/playlists.md).
- [x] V2.57 genre/scoped-album/folder playback with HTTP preflight, filtered
  ...
  recovery: [library browsing](../../docs/protocol/library-browsing.md). Physical app sequence and
...
- [x] Seven V2.57 category-deletion scopes on generated media, with favorite/
  custom-list loss, stale references and scan recovery: [deletion contract](../../docs/protocol/library-delete.md).
- [x] V2.57 cooperative scan cancellation, partial replacement index and full-scan
  recovery over TCP/WS: [scan lifecycle](../../docs/protocol/library-scan.md).
- [x] Dedicated V2.57 index/favorites reset, explicit confirmation, preserved
  source/settings/custom lists and recovery limits: [reset contract](../../docs/protocol/library-reset.md).
- [x] Natural EOF observed in all five V2.57 local modes over TCP/WS with
  ...
  silent `0202` after stop: [EOF contract](../../docs/protocol/track-end.md).
- [x] Generated CUE/WAV, DSF and DFF metadata and positional queue/favorite
  selection over TCP/WS; stock identity collisions/losses: [formats](../../docs/protocol/formats.md).
- [x] Gain, DRE, filter, SPDIF, PEQ read/write and persistence:
  [settings](../../docs/protocol/remote-settings.md). These checks do not measure DSP output.
- [x] Channel-balance contract: `0712` read / `0713` write / `a712` reply,
  ...
  [evidence and reproduction](../../docs/protocol/remote-settings.md#channel-balance).
- [x] Work-mode and Bluetooth source-codec preference controls, stock/custom theme
  APIs: [modes and themes](../../docs/protocol/remote-modes-themes.md).
- [x] Sanitized FiiO Control iOS capture fixtures, app-version evidence, and
  [Android comparison](reports/m21-comparison.md): [app evidence](reports/fiio-control-app.md).
...
by these phone previews. [Evidence](reports/fiio-control-app.md#physical-system-theme-colors-2026-09-16).
...
reboot persistence claim. [Evidence and regression fixture](reports/fiio-control-app.md#physical-system-theme-opacity-2026-09-16).
...
[Evidence, frames and limits](../../docs/protocol/library-delete.md#physical-source-file-deletion-and-retained-b1-2026-09-16).
...
[Evidence and limits](../../docs/protocol/library-delete.md#physical-ios-track-deletion-and-unsupported-group-action-2026-09-16).
...
The [contract](../../docs/protocol/library-delete.md) records membership loss despite preserved
...
Details and current validation: [IDLE_POWER.md](../../emulator/docs/idle-power.md).
...
selection is recorded in [CI.md](../../docs/development/ci.md#test-selection-policy).
...
did not produce the expected playing state. See [capture evidence](../../docs/protocol/library-browsing.md#physical-genre-flow-2026-09-16).
...
[physical evidence and limits](../../docs/protocol/library-browsing.md#physical-folder-album-and-artist-flow-2026-09-16).
...
[scope and stale-reference limits](../../docs/protocol/library-delete.md). Whole genre-album group addition and
playlist rename are now captured (`221421`), see
[evidence and pagination limit](../../docs/protocol/library-browsing.md#physical-genre-album-groups-and-playlist-rename-2026-09-16).
...
matrix is in [LIBRARY_DELETE.md](../../docs/protocol/library-delete.md). See [physical addition](../../docs/protocol/library-browsing.md#physical-album-track-addition-2026-09-16).
See [the corrected scenario](../../docs/protocol/library-browsing.md#pass-b-album-track-batch-addition-corrected-after-img_6818).
...
so it does not close root-page Play all. The [durable action and analysis checklist](../../docs/protocol/library-browsing.md#next-app-capture-folders-and-root-play-all)
...
[capture evidence](reports/fiio-control-app.md#physical-custom-theme-save-2026-09-16).
...
Read `AGENTS.md`, [EMULATION.md](../../emulator/docs/emulation.md) and [CI.md](../../docs/development/ci.md) first. Resolve
...
- [x] **Stock Gain/filter labels:** V2.57 UI/resource/callback tracing maps
  ...
  clipped. [Verified table](../../docs/protocol/remote-settings.md#gain-and-filter-labels-v257).
...
- [x] **Playback preferences:** gapless/folder jump/ReplayGain have read-only
  ...
  unsupported. See [contract and static addresses](../../docs/protocol/remote-settings.md#playback-preferences-v257).
...
- [x] **Category DELETE scope on disposable V2.57:** list-member removal, favorite
  ...
  [Seven-case matrix and limits](../../docs/protocol/library-delete.md).
...
- [x] **iOS track Delete with source checked:** `225423` sends flag one and
  ...
  total and refresh from zero. [Evidence](../../docs/protocol/library-delete.md).
...
- [x] **Captured whole-genre Play all:** type 8 / empty album now exposed after
  ...
  stay type 8. [Contract and limits](../../docs/protocol/library-browsing.md).
...
- [x] **Cancel indexing:** `0622/0001` stops cooperatively, leaves a partial
  ...
  See [contract and tests](../../docs/protocol/library-scan.md). Not a library-reset command.
- [x] **Dedicated library reset:** identified stock `0621/0000` and tested its
  ...
  acceptance passed; see [reset contract](../../docs/protocol/library-reset.md). Actual app
...
- [x] **Natural end of track/list:** all five modes observed over TCP/WS using
  ...
  see [scope and limitations](../../docs/protocol/track-end.md). Physical timing remains unvalidated.
- [x] **CUE/DSF/DFF metadata and identity:** generated external UTF-8 CUE and
  ...
  ID/HTTP-mark ambiguity. See [scope and limitations](../../docs/protocol/formats.md).
- [x] **SACD ISO local metadata/selection:** approved ten-track stereo image
  ...
  including TCP/WS favorites and same-path metadata replacement; see [SACD.md](reports/sacd.md).
...
- [x] **Custom-theme color/Date save in FiiO Control:** physical HAR/PCAP confirms
  ...
  Clock selection has 200 but no final GET. See [evidence](reports/fiio-control-app.md#physical-custom-theme-save-2026-09-16).
- [x] **Four custom styles:** physical POST/GET captures confirm `default/0`,
  ...
  independent time off/on. [Evidence and limits](reports/fiio-control-app.md#physical-custom-style-save-2026-09-16).
...
- [x] **Screen/capability audit:** supplied screenshots and subsequent captures
  are mapped to helpers, evidence and limits in [the app inventory](reports/fiio-control-app.md)
  and [final controller contract](../../docs/protocol/disc-capabilities.md). Root Play all no-dispatch,
...
- [x] **UDP LAN discovery contract:** exact physical payload observed; controlled
  emulator idle/connected/disconnected lifecycle passed. [Details](../../controller/docs/discovery.md).
...
- [x] **Emulator remote connection versus idle power:** screen-off, pause,
  ...
  remote wake. See [current investigation](../../emulator/docs/idle-power.md)
  and [earlier failure evidence](../../docs/development/ci.md#idle-shutdown-versus-protocol-failure).
...
is indexed in [FIIO_CONTROL_APP.md](reports/fiio-control-app.md).
...
The subsequent deletion checkpoint is documented in [LIBRARY_DELETE.md](../../docs/protocol/library-delete.md).
See [contract and limits](../../docs/protocol/library-browsing.md#physical-genre-album-groups-and-playlist-rename-2026-09-16).
...
rerun, physical replay or interactive guest modification. See [contract and limits](../../docs/protocol/library-browsing.md#physical-folder-album-and-artist-flow-2026-09-16).
...
appears. [Evidence](../../docs/protocol/library-browsing.md#root-tab-play-all-produces-no-playback-request-2026-09-16).
...
See [physical evidence and fixture](../../docs/protocol/remote-settings.md#physical-fiio-control-filter-mapping-2026-09-16).
...
[idle-shutdown analysis](../../docs/development/ci.md#idle-shutdown-versus-protocol-failure).
...
injection or speed modification. See [the contract](../../docs/protocol/track-end.md) for addresses,
...
proof of native DSD/DoP output. [FORMATS.md](../../docs/protocol/formats.md) is the detailed contract.
...
became LAN discovery. See [DISCOVERY.md](../../controller/docs/discovery.md) for the wire contract,
...
See [the complete contract and addresses](../../emulator/docs/idle-power.md).
