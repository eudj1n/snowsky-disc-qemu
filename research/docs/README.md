# Firmware research documentation

Analysis methods, diagnostic tools and attributed evidence. Start with the current status before resuming any investigation.

- [Read-only firmware diagnostics](diagnostics.md)
- [Firmware analysis methods](methods.md)
- [DISC research status](status.md)
