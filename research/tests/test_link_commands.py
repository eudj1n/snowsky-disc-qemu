...
from research.diagnostics.inspect_link_commands import commands, parse_allowlist
...
class LinkCommandTests(unittest.TestCase):
    ...
    def test_rejects_profile_without_reviewed_layout(self):
        with patch('research.diagnostics.inspect_link_commands.identify_player', return_value={'diagnostics': {'network': {}}}):
