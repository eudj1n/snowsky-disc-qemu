...
#
# Usage:  research/diagnostics/gdb_probe.sh <gdb-cmd-file> [port]     (run INSIDE the container)
#   e.g.  research/diagnostics/gdb_probe.sh /repo/research/ghidra/probe_out_device.gdb
set -euo pipefail
